...
export const translations = {
  en: {
    ...
    autoFillFromRecommendations: 'Fill from Recommendations',
    loadingRecommendations: 'Loading...',
    autoFillDialogTitle: 'Fill Trading Symbols from Recommendations',
    autoFillMode: 'Mode',
    replaceExistingCoins: 'Replace Existing',
    appendToExistingCoins: 'Append to Existing',
    selectCoinCategories: 'Select Coin Categories',
    includeMajorCoins: 'Major Coins (BTC, ETH)',
    includeAltcoins: 'Altcoins',
    recommendationsFilled: 'Recommendations filled successfully',
    failedToLoadRecommendations: 'Failed to load recommendations',
    noRecommendationsFound: 'No recommendations found for this strategy',
    selectAtLeastOneCategory: 'Please select at least one coin category',
  ...
  zh: {
    ...
    quickSelection: '快速选择',
    autoFillFromRecommendations: '从推荐填充',
    loadingRecommendations: '加载中...',
    autoFillDialogTitle: '从推荐填充交易币种',
    autoFillMode: '模式',
    replaceExistingCoins: '替换现有',
    appendToExistingCoins: '追加到现有',
    selectCoinCategories: '选择币种类别',
    includeMajorCoins: '主流币种 (BTC, ETH)',
    includeAltcoins: '山寨币',
    recommendationsFilled: '推荐填充成功',
    failedToLoadRecommendations: '加载推荐失败',
    noRecommendationsFound: '未找到该策略的推荐',
    selectAtLeastOneCategory: '请至少选择一个币种类别',
